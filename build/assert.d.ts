...
export declare function bigint(value: any, message: string): asserts value is bigint;
export declare function number(value: any, message: string): asserts value is number;
export declare function numeric(value: any, message: string): asserts value is (bigint | number);
...
export declare function bigintArray(value: any, message: string): asserts value is bigint[];
...
export declare function strArray2D(value: any, message: string): asserts value is string[][];
export declare function numArray3D(value: any, message: string): asserts value is number[][][];
export declare function strArray3D(value: any, message: string): asserts value is string[][][];

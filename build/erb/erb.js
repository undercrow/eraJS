...
const commandParser = {
    ...
    PRINTLC: (arg) => [new PrintC("LEFT", "L", arg), 1],
    PRINTLCK: (arg) => [new PrintC("LEFT", "KL", arg), 1],
    PRINTLCD: (arg) => [new PrintC("LEFT", "DL", arg), 1],
    ...
    PRINTFORMLC: (arg) => [new PrintFormC("LEFT", "L", arg), 1],
    PRINTFORMLCK: (arg) => [new PrintFormC("LEFT", "KL", arg), 1],
    PRINTFORMLCD: (arg) => [new PrintFormC("LEFT", "DL", arg), 1],

...
function parseFn(lines, from) {
    ...
    const argParser = U.sepBy0(",", P.seq(X.variable, P.alt(P.string("=").trim(C.WS0).then(C.Int), P.string("=").trim(C.WS0).then(C.Str), P.string("=").trim(C.WS0).then(X.variable), P.succeed(null))));
